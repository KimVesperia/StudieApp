...
public class CourseListMinorsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CourseListMinorsActivity.this, AddCourseMinorActivity.class));
            }
        });
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(name)){
                    editTextName.setError("Voer een minor in...");
                    return;
                }
    ...
    private void deleteCourse(String courseName){
        DatabaseReference drCourse = FirebaseDatabase.getInstance().getReference("courses/minors").child(courseName);
    ...
    private boolean updateCourse(String id, String name, String year, String period, String ec, String grade, String comments, String special, String status){
        ...
        DatabaseReference databaseCourses = FirebaseDatabase.getInstance().getReference("courses/minors").child(name);

        Course course = new Course(id, name, year, period, ec, grade, comments, special, status);

        databaseCourses.setValue(course);

        Toast.makeText(this, "Minor Succesvol Aangepast", Toast.LENGTH_LONG).show();
    ...
    protected void onStart() {
        ...
        query.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot){
                ...
                CourseList adapter = new CourseList(CourseListMinorsActivity.this, courses);
