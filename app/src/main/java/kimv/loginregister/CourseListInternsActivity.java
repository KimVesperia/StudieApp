...
public class CourseListInternsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CourseListInternsActivity.this, AddCourseInternActivity.class));
            }
        });
    ...
    private void showUpdateDialog(final String courseId, final String courseName, String courseEC, String courseGrade, String courseComments){
        ...
        final View dialogView = inflater.inflate(R.layout.update_dialog6, null);
        ...
        buttonUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(TextUtils.isEmpty(name)){
                    editTextName.setError("Voer een stage in...");
                    return;
                }
    ...
    private void deleteCourse(String courseName){
        DatabaseReference drCourse = FirebaseDatabase.getInstance().getReference("courses/interns").child(courseName);
    ...
    private boolean updateCourse(String id, String name, String year, String period, String ec, String grade, String comments, String special, String status){
        ...
        DatabaseReference databaseCourses = FirebaseDatabase.getInstance().getReference("courses/interns").child(name);

        Course course = new Course(id, name, year, period, ec, grade, comments, special, status);

        databaseCourses.setValue(course);

        Toast.makeText(this, "Stage Succesvol Aangepast", Toast.LENGTH_LONG).show();
    ...
    protected void onStart() {
        ...
        query.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot){
                ...
                CourseList adapter = new CourseList(CourseListInternsActivity.this, courses);
