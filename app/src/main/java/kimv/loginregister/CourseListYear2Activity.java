...
public class CourseListYear2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseCourses = FirebaseDatabase.getInstance().getReference("courses/year2");
    ...
    private void deleteCourse(String courseName){
        DatabaseReference drCourse = FirebaseDatabase.getInstance().getReference("courses/year2").child(courseName);
    ...
    private boolean updateCourse(String id, String name, String year, String period, String ec, String grade, String comments, String special, String status){
        ...
        DatabaseReference databaseCourses = FirebaseDatabase.getInstance().getReference("courses/year2").child(name);
