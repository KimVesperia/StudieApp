...
public class CourseListYear1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseCourses = FirebaseDatabase.getInstance().getReference("courses/year1");

        FloatingActionButton fab = findViewById(R.id.addCourse);
        fab.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(CourseListYear1Activity.this, AddCourse1Activity.class));
            }
        });
    ...
    private void deleteCourse(String courseName){
        DatabaseReference drCourse = FirebaseDatabase.getInstance().getReference("courses/year1").child(courseName);
    ...
    private boolean updateCourse(String id, String name, String year, String period, String ec, String grade, String comments, String special, String status){
        ...
        DatabaseReference databaseCourses = FirebaseDatabase.getInstance().getReference("courses/year1").child(name);
    ...
    protected void onStart() {
        ...
        query.addValueEventListener(new ValueEventListener(){
            ...
            public void onDataChange(DataSnapshot dataSnapshot){
                ...
                CourseList adapter = new CourseList(CourseListYear1Activity.this, courses);
